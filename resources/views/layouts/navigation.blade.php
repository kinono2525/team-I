<nav x-data="{ open: false }" class="bg-sky-400 dark:bg-sky-600 border-b border-sky-500 dark:border-sky-700">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white dark:text-white bg-sky-500 dark:bg-sky-700 hover:bg-sky-600 dark:hover:bg-sky-800 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-sky-500 dark:border-sky-700">
            <div class="px-4">
